use utf8;
package mcr_metabase::Schema::Result::VwEmlAttributelist;
...
mcr_metabase::Schema::Result::VwEmlAttributelist
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mzE+SmhnYgbcL+DP4z7ATA
