use utf8;
package mcr_metabase::Schema::Result::VwEmlAssociatedparty;
...
mcr_metabase::Schema::Result::VwEmlAssociatedparty
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:R2kx+SgnJ1o65zsz+QvkCQ
